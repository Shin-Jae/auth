    ...
    return (
        <form className="new-group-form" onSubmit={handleSubmit}>
            ...
            <label>
                ...
                >
                    <option value={null} onChange={(e) => handleCategory(e.target.value)}>Select One</option>
                    <option value={1} onChange={(e) => handleCategory(e.target.value)}>Adventure</option>
                    <option value={2} onChange={(e) => handleCategory(e.target.value)}>Sports</option>
                    <option value={3} onChange={(e) => handleCategory(e.target.value)}>Heros</option>
                    <option value={4} onChange={(e) => handleCategory(e.target.value)}>Music</option>
                    <option value={5} onChange={(e) => handleCategory(e.target.value)}>Miscellaneous</option>
                </select>
            </label>
            <label>
